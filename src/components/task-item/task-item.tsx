...
import { TaskStatusBar } from "@/components/ui/status-bar/task-status-bar";
...
export function TaskItem({
  ...
  return (
    <div className="flex justify-between items-center p-6 rounded-2xl shadow-ring">
      ...
      <div>
        ...
        <div className="flex items-center text-sm">
          <div className="mr-2">
            <Image width={22} height={22} alt="calendar" src={CalendarImg} />
          </div>
